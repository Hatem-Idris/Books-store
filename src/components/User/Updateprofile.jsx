...
export default function ProfileEdit() {
  ...
  return (
    <div className="flex flex-col min-h-dvh items-center gap-6">

      <div className="absolute bottom-120 lg:bottom-5/12">
      ...
      <div className="w-full p-2 md:w-10/12 lg:w-8/12 xl:w-6/12 mt-30">
        <Formik
          enableReinitialize
